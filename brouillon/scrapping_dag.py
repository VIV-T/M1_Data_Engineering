...
with DAG(
    ...
    #--Tasks--
    initialize_alpha_index = PythonOperator(
        task_id = "initialize_alpha_index", 
        python_callable = _initialize_alpha_index
    )

    
    get_dict_name_list= PythonOperator(
        task_id = "get_dict_name_list", 
        python_callable = _get_dict_name_url_list, 
        op_kwargs = {
            "url" : "False"
        }
    )
    ...
    get_dict_url_list= PythonOperator(
        task_id = "get_dict_url_list", 
        python_callable = _get_dict_name_url_list, 
        op_kwargs = {
            "url" : "True"
        }
    ...
    get_all_scripts= PythonOperator(
        task_id = "get_all_scripts", 
        python_callable = _get_all_scripts
    )



    #--Graph--
    initialize_alpha_index >> \
    get_dict_name_list >> get_dict_url_list >> get_all_scripts